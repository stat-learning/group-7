...
categoricals <- categoricals %>%
  mutate(REGION = factor(categoricals$REGION), 
         CONTROL = factor(categoricals$CONTROL),
         HIGHDEG = factor(categoricals$HIGHDEG)) 
```
...
With the data now in workable format, we can start to take a look at our response and predictors. Our new dataset has 2,822 observations of 82 variables--significantly cut down from our initial one. 

Our response variable, MD_EARN_WNE_P6, is distributed fairly normally. A histogram of our response is shown below.
