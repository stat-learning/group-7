...
set.seed(1)
rf.college.mice = randomForest(log_md_wage  ~., data = df.forest.mice, na.action = na.roughfix, importance = TRUE)
...
set.seed(1)
rf.college.missForest = randomForest(log_md_wage  ~., data = missForest_df_forest, na.action = na.roughfix, importance = TRUE)
